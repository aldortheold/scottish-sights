const names = ["Edinburgh Castle", "Loch Ness", "Aberdeen", "Fingal's Cave", "New Lanark", "Luskentyre Beach", "Dunrobin Castle"];
...
const namesRu = ["Эдинбургский Замок", "Лох-Несс", "Абердин", "Фингалова Пещера", "Нью-Ланарк", "Пляж Ласкентайр", "Замок Данробин"];
